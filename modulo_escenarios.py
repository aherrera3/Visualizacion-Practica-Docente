...
rutherford = vp.graph(title=s, xtitle='angulo', ytitle='# particulas', fast=False, width=600)
...
def escenario1_creacion():
    ...
    vp.text(text='Modelo Estandar',pos=vp.vector(40,29,0), align='center', color=vp.color.green,height=5)
    vp.text(text='Leptones',pos=vp.vector(5,25,0), align='center', color=vp.color.green,height=3)
    vp.text(text='Quarks',pos=vp.vector(25,25,0), align='center', color=vp.color.purple,height=3)
    vp.text(text='Bosones',pos=vp.vector(65,25,0), align='center', color=vp.color.red,height=3)
    ...
    vp.label(pos=particulas_bosonicas[0][0].pos-zoom_label, text='Z', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    vp.label(pos=particulas_bosonicas[0][1].pos-zoom_label, text='Bosones W', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    vp.label(pos=particulas_bosonicas[1][0].pos-zoom_label, text='Fotón', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_bosonicas[1][0].color=vp.vector(255/273, 242/273, 0)
    particulas_bosonicas[1][0].emissive=True
    vp.label(pos=particulas_bosonicas[1][1].pos-zoom_label, text='Gluón', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    vp.label(pos=particulas_bosonicas[2][0].pos-zoom_label, text='Higgs', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 

    vp.label(pos=particulas_fermionicas[0][0].pos-zoom_label, text='Electrón', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_fermionicas[0][0].color=vp.vector(0, 74, 2)/273

    vp.label(pos=particulas_fermionicas[1][0].pos-zoom_label, text='Muón', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_fermionicas[1][0].color=vp.vector(0, 189, 9)/273    

    vp.label(pos=particulas_fermionicas[2][0].pos-zoom_label, text='Tau', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_fermionicas[2][0].color=vp.vector(0, 255, 12)/273    

    vp.label(pos=particulas_fermionicas[0][1].pos-zoom_label, text='Neutrino \nElectrónico', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_fermionicas[0][1].color=vp.vector(0, 74, 2)/273    

    vp.label(pos=particulas_fermionicas[1][1].pos-zoom_label, text='Neutrino \nMuónico', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_fermionicas[1][1].color=vp.vector(0, 189, 9)/273    

    vp.label(pos=particulas_fermionicas[2][1].pos-zoom_label, text='Neutrino \nTauónico', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_fermionicas[2][1].color=vp.vector(0, 255, 12)/273       

    vp.label(pos=particulas_fermionicas[0][2].pos-zoom_label, text='Down', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_fermionicas[0][2].color=vp.vector(52, 0, 92)/273

    vp.label(pos=particulas_fermionicas[1][2].pos-zoom_label, text='Strange', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
    particulas_fermionicas[1][2].color=vp.vector(88, 0, 156)/273

    vp.label(pos=particulas_fermionicas[2][2].pos-zoom_label, text='Bottom', color=vp.vector(0.1,1,0.7), opacity=0.7, height=15, box=0) 
...
def dar_mensaje_escenario1(identificador: str)->str:
    ...
    if identificador=="bosones:0,0":
        ...
        mensaje="              "+'<img src="imagenes/muon.png" width=420 height=210>'+"            "+'<img src="imagenes/muon_descubrimiento.png" width=400 height=200>'+"\n\n\n"
    elif identificador=="fermiones:2,0":     
        mensaje="              "+'<img src="imagenes/tau.png" width=420 height=210>'+"            "+'<img src="imagenes/tau_descubrimiento.png" width=400 height=200>'+"\n\n\n"
    elif identificador=="fermiones:0,1":     
        mensaje="              "+'<img src="imagenes/neutrinoElectronico.png" width=420 height=200>'+"            "+'<img src="imagenes/neutrinoElectronico_descubrimiento.png" width=400 height=235>'+"\n\n\n"
    elif identificador=="fermiones:1,1":     
        mensaje="              "+'<img src="imagenes/neutrinoMuonico.png" width=420 height=200>'+"            "+'<img src="imagenes/neutrinoMuonico_descubrimiento.png" width=400 height=220>'+"\n\n\n"
        ...
        mensaje="              "+'<img src="imagenes/strange.png" width=420 height=220>'+"            "+'<img src="imagenes/strange_descubrimiento.png" width=500 height=209>'+"\n\n\n"
...
m_alfa=6.64e-27
pos,vel = vp.vector(-8,0.5,0),vp.vector(5,0,0)
...
def escenario2_creacion():
    ...
    vp.sphere(pos=vp.vector(0,0,0), radius=0.5, color=color, shininess=0, masa=m_nucleo, velocidad=vp.vector(0,0,0)) 
    particulas.append([mod.Alpha(pos, vel, m_alfa, 0.2, "Alpha", conversion), True]) #booleano determina si la particula se mueve o no  
    ...
    for i in range(len(particulas)):
        ...
        if particulas[i][1]:
            ...
            if(round(particulas[i][0].posicion.x, 0) == 0):
                ...
                particulas[i][0].cambiar_longitud_onda(l_nueva) #cambia el color de la particula y del trail
        ...
        if(t>3):
            ...
            vel = vp.vector(5,0,0)
            particulas.append([mod.Alpha(pos, vel, m_alfa, 0.2, "Alpha", conversion),True]) 
            t=0
            n+=1
    t+=dt
